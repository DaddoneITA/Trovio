    ...
    <footer className="border-t border-[var(--color-border)] bg-[var(--color-bg)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="text-sm font-semibold mb-4 text-[var(--color-text)]">Risorse</h4>
            <ul className="space-y-2">
              <li><a href="#" className="text-sm text-[var(--color-text-secondary)] hover:text-[var(--color-text)] transition-colors">Guida</a></li>
              <li><a href="#" className="text-sm text-[var(--color-text-secondary)] hover:text-[var(--color-text)] transition-colors">Blog</a></li>
              <li><a href="#" className="text-sm text-[var(--color-text-secondary)] hover:text-[var(--color-text)] transition-colors">Supporto</a></li>
            </ul>
          </div>
        </div>
